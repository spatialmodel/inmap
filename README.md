...
_Note: This is the documentation for InMAP version 1.4. Documentation for other versions is available [here](https://github.com/spatialmodel/inmap/releases)._

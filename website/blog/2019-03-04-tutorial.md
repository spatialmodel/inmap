...
For the on-road total emission shapefile, it can be download from here: [https://drive.google.com/file/d/1AP5fMzeWztRHx_3XJxEcG6bCJdb1ROgC/view?usp=sharing](https://drive.google.com/file/d/1AP5fMzeWztRHx_3XJxEcG6bCJdb1ROgC/view?usp=sharing). The shapefile can be open and edit on a bunch of GIS software. For individual users, QGIS is one of the most generally used GIS application since it is free and includes most of commonly used functions. It is compatible with Windows, Mac and Linux system. This tutorial will demonstrate all the operations need to be done on a GIS platform, including the data preparing and post-process.

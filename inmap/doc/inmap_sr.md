...
```
      ...
      --VarGrid.MortalityRateColumns stringSlice   
              ...
              in units of deaths per year per 100,000 people. (default [AllCause,WhNoLMort,BlackMort,AsianMort,NativeMort,LatinoMort])
